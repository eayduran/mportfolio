  ...
  const [projectswidthcont, setPrjwcont] = useState(71)
    ...
    return(        
        <div id="projects" className="pb-8 justify-start overflow-x-hidden space-y-8 h-screen flex flex-col items-center min-w-screen bg-secondary text-white font-sans">
                    <div className="bg-blue-200 text-white flex items-center justify-start w-full font-bold h-20 text-4xl font-sans">
                    ...
                    {/* <div className="flex text-white bg-gray-700 w-full h-screen text-4xl font-sans"> */}
                                    <div id="projectscontdiv" className="flex justify-center my-4 p-4 w-full h-screen text-4xl font-sans" style={{marginLeft: scr<150?3000: (3000 - 5*scr)>=(swidth/2 - projectswidthcont/2)? 3000 - 5*scr: (swidth/2 - projectswidthcont/2)}}>
                                        <div className="flex flex-col justify-between py-6 px-2 w-1/4 bg-gray-800 items-center">
                                            <div className="w-5/6 h-5/6 border-solid border-b-8 border-l-8 flex flex-col justify-center">
                                                <div className="border-solid border-4 rotate-46 text-4xl left-8 top-28 -mb-3 relative">
                                                    Portfolio
                                                </div>
                                                <div className="border-solid border-4 rotate-46 mt-6 mr-2 text-4xl right-6 top-14 relative">
                                                    E-commerce
                                                </div>
                                            </div>
                                            <div>
